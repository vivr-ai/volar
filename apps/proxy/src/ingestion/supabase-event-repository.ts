...
// only translates that function's two I/O calls into real Supabase
// queries. Consumed by the future ingestion endpoint (issue 6.1) and
// queue worker (issue 7.3), both of which need the same DB wiring.
//
